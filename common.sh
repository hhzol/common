...
git clone --depth=1 https://github.com/UnblockNeteaseMusic/luci-app-unblockneteasemusic.git ${HOME_PATH}/package/luci-app-unblockneteasemusic
...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-unblockneteasemusic,vlmcsd,luci-app-vlmcsd,luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya}
