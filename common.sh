...
rm -rf ${HOME_PATH}/package/feeds/packages/{jool,sub-web,dae,onionshare-cli,cloudreve}
rm -rf ${HOME_PATH}/feeds/packages/net/{jool,sub-web,dae,onionshare-cli,cloudreve}
