...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-filebrowser,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya,luci-app-unblockneteasemusic}
