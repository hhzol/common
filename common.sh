...
#luci-app-gost,gost,luci-app-smartdns,smartdns,luci-app-wizard,luci-app-msd_lite,msd_lite, luci-app-usb-printer, UnblockNeteaseMusic, luci-app-unblockneteasemusic, \
...
#        -path "${HOME_PATH}/feeds/smpackage" -prune -o \
...
rm -rf ${HOME_PATH}/feeds/luci/applications/{vlmcsd,luci-app-vlmcsd,luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya,luci-app-unblockneteasemusic}
