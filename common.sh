...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-dockerman,vlmcsd,luci-app-vlmcsd,luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya}
