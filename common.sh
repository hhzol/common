...
git clone --depth=1 https://github.com/sirpdboy/luci-app-netspeedtest.git ${HOME_PATH}/package/netspeedtest
git clone --depth=1 https://github.com/sirpdboy/luci-app-netwizard.git ${HOME_PATH}package/luci-app-netwizard
...
rm -rf ${HOME_PATH}/feeds/luci/applications/{vlmcsd,luci-app-vlmcsd,luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya}
