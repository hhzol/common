...
#echo "src-git smpackage https://github.com/kenzok8/small-package.git;main" >> "${HOME_PATH}/feeds.conf.default"
...
git clone --depth=1 https://github.com/hhzol/homeproxy.git ${HOME_PATH}/package/luci-app-homeproxy
...
#替换rockchip文件
#rm -rf "${HOME_PATH}/package/boot/arm-trusted-firmware-rockchip"
#cp -Rf "$LINSHI_COMMON/Share/r2s/arm-trusted-firmware-rockchip" "${HOME_PATH}/package/boot/arm-trusted-firmware-rockchip"
...
rm -rf ${HOME_PATH}/feeds/smpackage/{luci-app-vlmcsd,vlmcsd,luci-app-store,luci-lib-taskd,luci-lib-xterm,taskd,LingTiGameAcc,MentoHUST-OpenWrt-ipk,UA2F,UnblockNeteaseMusic-Go,UnblockNeteaseMusic,adguardhome,airconnect,alac,alist,aliyundrive-fuse,aliyundrive-webdav,amule,aria2,ariang,autoshare-ksmbd,autoshare-samba,autoupdate,baidupcs-web,base-files,brook,btop,cdnspeedtest,cgroupfs-mount,chinadns-ng,coremark,cpulimit,cups,dae,daed-next,daed,ddns-go,ddns-scripts,ddnsto,dns2socks-rust,dns2socks,dns2tcp,dnsforwarder,dnsmasq,dnsproxy,doc,docker-lan-bridge,docker,dockerd,easytier,fail2banop,fastnet,ffmpeg-remux,ffmpeg-static,filebrowser,firewall,firewall4,floatip,frp,fullconenat-nft,fullconenat,geoview,gmediarender,gn,go-aliyundrive-webdav,gost,haproxy,headscale,homebox,homeredirect,hysteria,ipt2socks,iptvhelper,istoreenhance,jpcre2,lcdsimple,libcron,libdouble-conversion,libnftnl,libtorrent-rasterbar,lingtigameacc,linkease,linkmount,lua-ipops,lua-maxminddb,lua-neturl,luci-app-3ginfo-lite,luci-app-LingTiGameAcc,luci-app-UUGameAcc,luci-app-adguardhome,luci-app-advanced,luci-app-aihelper,luci-app-airconnect,luci-app-aliddns,luci-app-alist,luci-app-aliyundrive-fuse,luci-app-aliyundrive-webdav,luci-app-alpha-config,luci-app-amlogic,luci-app-ap-modem,luci-app-arcadia,luci-app-argon-config,luci-app-argone-config,luci-app-autoipsetadder,luci-app-autorepeater,luci-app-autoshell,luci-app-autotimeset,luci-app-autoupdate,luci-app-baidupcs-web,luci-app-bandwidthd,luci-app-beardropper,luci-app-bypass,luci-app-chatgpt-web,luci-app-chinesesubfinder,luci-app-chongyoung,luci-app-chongyoung2.0,luci-app-clash,luci-app-clouddrive2,luci-app-cloudflarespeedtest,luci-app-codeserver,luci-app-control-timewol,luci-app-control-webrestriction,luci-app-control-weburl,luci-app-cupsd,luci-app-dae,luci-app-daed-next,luci-app-daed,luci-app-ddns-go,luci-app-ddnsto,luci-app-demon,luci-app-design-config,luci-app-diskman,luci-app-dnscrypt-proxy2,luci-app-dnsfilter,luci-app-dnsmasq-ipset,luci-app-dnsproxy,luci-app-dockerman,luci-app-dogcom,luci-app-dpanel,luci-app-drawio,luci-app-droidmodem,luci-app-easymesh,luci-app-easytier,luci-app-easyupdate,luci-app-emby,luci-app-eqos,luci-app-eqosplus,luci-app-excalidraw,luci-app-fakemesh,luci-app-fastnet,luci-app-fchomo,luci-app-feishuvpn,luci-app-fileassistant,luci-app-filebrowser-go,luci-app-filebrowser,luci-app-floatip,luci-app-fullconenat,luci-app-gecoosac,luci-app-go-aliyundrive-webdav,luci-app-godproxy,luci-app-gogs,luci-app-gost,luci-app-gowebdav,luci-app-guest-wifi,luci-app-heimdall,luci-app-homeassistant,luci-app-homebridge,luci-app-homeproxy,luci-app-homeredirect,luci-app-htreader,luci-app-ikoolproxy,luci-app-immich,luci-app-internet-detector,luci-app-iperf3-server,luci-app-ipsec-server,luci-app-iptvhelper,luci-app-istoredup,luci-app-istoreenhance,luci-app-istorego,luci-app-istorepanel,luci-app-istorex,luci-app-ittools,luci-app-jackett,luci-app-jellyfin,luci-app-kai,luci-app-kodexplorer,luci-app-koolproxyR,luci-app-lanraragi,luci-app-lingtigameacc,luci-app-linkease,luci-app-lucky,luci-app-mac,luci-app-macvlan,luci-app-mail,luci-app-memos,luci-app-mentohust,luci-app-mfun,luci-app-minieap,luci-app-momo,luci-app-mosdns,luci-app-msd_lite,luci-app-mtphotos,luci-app-multiaccountdial,luci-app-my-dnshelper,luci-app-mymind,luci-app-nastools,luci-app-nat6-helper,luci-app-natmap,luci-app-natter,luci-app-natter2,luci-app-navidrome,luci-app-nekobox,luci-app-netdata,luci-app-netkeeper-interception,luci-app-netspeedtest,luci-app-nextcloud,luci-app-nginx-manager,luci-app-nginx-pingos,luci-app-nikki,luci-app-npc,luci-app-oaf,luci-app-oled,luci-app-oneapi,luci-app-onliner,luci-app-openclash,luci-app-openlist,luci-app-openlist2,luci-app-openvpn-client,luci-app-openvpn-server,luci-app-openwebui,luci-app-ota,luci-app-owntone,luci-app-packet-capture,luci-app-partexp,luci-app-penpot,luci-app-photoprism,luci-app-plex,luci-app-poweroff,luci-app-poweroffdevice,luci-app-pppoe-relay,luci-app-pppoe-server,luci-app-pptp-server,luci-app-pushbot,luci-app-pve,luci-app-qbittorrent,luci-app-quickstart,luci-app-ramfree,luci-app-routerdog,luci-app-rtbwmon,luci-app-rtorrent,luci-app-runmynas,luci-app-shadowrt,luci-app-shanligong,luci-app-shortcutmenu,luci-app-shutdown,luci-app-smartdns,luci-app-sms-tool,luci-app-snmpd,luci-app-socat,luci-app-softethervpn,luci-app-speedtest-web,luci-app-ssr-mudb-server,luci-app-ssr-plus,luci-app-subconverter,luci-app-sunpanel,luci-app-supervisord,luci-app-suselogin,luci-app-syncdial,luci-app-syncthing,luci-app-systools,luci-app-sysuh3c,luci-app-tailscale,luci-app-taskplan,luci-app-tcpdump,luci-app-tencentcloud-cos,luci-app-tencentddns,luci-app-timecontrol,luci-app-timewol,luci-app-tinyfilemanager,luci-app-torbp,luci-app-transmission,luci-app-ttnode,luci-app-typecho,luci-app-ubuntu,luci-app-ubuntu2,luci-app-udp2raw,luci-app-unblockmusic,luci-app-unblockneteasemusic,luci-app-unifi,luci-app-unishare,luci-app-uptimekuma,luci-app-usb-printer,luci-app-usb3disable,luci-app-v2raya,luci-app-vaultwarden,luci-app-verysync,luci-app-vsftpd,luci-app-wan-mac,luci-app-watchdog,luci-app-webd,luci-app-webdav,luci-app-webviewdev,luci-app-webvirtcloud,luci-app-wechatpush,luci-app-wifidog,luci-app-wizard,luci-app-wolplus,luci-app-wrtbwmon,luci-app-wxedge,luci-app-xlnetacc,luci-app-xray,luci-app-xteve,luci-app-xunlei,luci-app-xunyou,luci-app-zdinnav,luci-lib-fs,luci-lib-iform,luci-mod-istorenext,luci-nginxer,luci-proto-minieap,luci-proto-netkeeper,luci-theme-alpha,luci-theme-argon,luci-theme-argone,luci-theme-atmaterial_new,luci-theme-design,luci-theme-edge,luci-theme-ifit,luci-theme-inas,luci-theme-material3,luci-theme-opentopd,luci-theme-tomato,luci-themedog,lucky,me,mentohust,mhz,microsocks,mihomo,miniupnpd-iptables,momo,mosdns,msd_lite,msmtp,mwan3,my-dnshelper,naiveproxy,nanohatoled,natflow,natter,natter2,netatalk,netdata,netkeeper-interception,netkeeper,netmaker,netspeedtest,nftables,nginx,ngrokc,nikki,nps,oaf,open-app-filter,opencode,openlist2,openvpn-easy-rsa-whisky,openwrt-fastfetch,openwrt-minieap,openwrt-minisign,openwrt-natmap,opkg,oscam,pdnsd-alt,pgyvpn,phtunnel,ppp,qbittorrent,qt6base,qt6tools,quickjspp,quickstart,rapidjson,rblibtorrent,redsocks2,routergo,rp-pppoe,scutclient,services,shadow-tls,shadowsocks-libev,shadowsocks-rust,shadowsocksr-libev,simple-obfs,sing-box,smartdns,speedtest-cli,speedtest-web,speedtestcli,ssocks,sub-web,subconverter,sunpanel,sysuh3c,tailscale,tcping,tcpping,toml11,transmission-web-control,transmission,trojan-go,trojan-plus,trojan,tuic-client,ucl,udp2raw,unishare,upx-static,upx,uwsgi,v2dat,v2ray-core,v2ray-geodata,v2ray-plugin,v2raya,verysync,vmease,vsftpd,watchcat,watchdog,webd,webdav2,wireless-regdb,wrtbwmon,wxbase,xray-core,xray-plugin,xunyou}
rm -rf ${HOME_PATH}/feeds/dstheme/{luci-app-advancedplus,luci-app-argon-config,luci-app-mosdns,luci-app-netkeeper-interception,luci-app-openlist,luci-app-smartdns,relevance}
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-bmx7,luci-app-homeproxy,luci-app-unblockneteasemusic,vlmcsd,luci-app-vlmcsd,luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya}
rm -rf ${HOME_PATH}/feeds/luci/themes/luci-theme-argon
rm -rf ${HOME_PATH}/package/feeds/packages/{ovsd,jool,sub-web,dae,onionshare-cli,cloudreve,openvswitch}
