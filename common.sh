...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-theme-argon,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya,luci-app-unblockneteasemusic}
