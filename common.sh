...
git clone https://github.com/sirpdboy/luci-app-netspeedtest.git ${HOME_PATH}/package/netspeedtest
git clone https://github.com/sirpdboy/luci-app-netwizard.git ${HOME_PATH}package/luci-app-netwizard
