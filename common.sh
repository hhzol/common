...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya,luci-app-unblockneteasemusic}
rm -rf ${HOME_PATH}/package/feeds/packages/{jool,sub-web,dae,onionshare-cli,cloudreve,openvswitch}
rm -rf ${HOME_PATH}/feeds/packages/net/{jool,sub-web,dae,onionshare-cli,cloudreve,openvswitch}
