...
mkdir -p luci//luci-applications/luci-app-vlmcsd
cp -a /tmp/imm-luci/applications/luci-app-vlmcsd luci/applications/luci-app-vlmcsd
rm -rf /tmp/imm-luci
...
rm -rf ${HOME_PATH}/feeds/luci/applications/{luci-app-filebrowser,luci-app-filebrowser-go,luci-app-usb-printer,luci-app-openclash,luci-app-passwall,luci-app-dae,luci-app-daed,luci-app-advanced-reboot,luci-app-v2raya,luci-app-unblockneteasemusic}
