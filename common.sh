...
#删除danshui中多余的主题和插件
rm -rf ${HOME_PATH}/feeds/danshui/{luci-app-passwall,luci-app-passwall2,luci-app-amlogic,luci-app-ssr-plus,luci-app-unblockneteasemusic,luci-app-homeproxy,luci-app-linkease,luci-app-istorex,luci-app-store,luci-app-istoreenhance}
